...
def process_fuel(origin_lon, origin_lat, size_m):
    ...
    with rasterio.open(tif_path) as src:
        ...
        print(f"Clipping Fuel TIF to {size_m}m area...")
    ...
    bfc_labels = {
        ...
        310: ("Broadleaf plantation", 0.60), 321: ("Radiata pine", 0.80), 322: ("Maritime pine", 0.82), 323: ("Southern pine", 0.78), 324: ("Other conifer", 0.75), 330: ("Other plantation", 0.55),
        411: ("Tall woodland with grassy understory", 0.88), 421: ("Woodland with shrubby understory", 0.80), 422: ("Woodland with spinifex understory", 0.95), 423: ("Woodland with grassy understory", 0.85), 424: ("Woodland with sparse understory", 0.65), 431: ("Low woodland with shrubby understory", 0.75), 432: ("Low woodland with spinifex understory", 0.92), 433: ("Low woodland with grassy understory", 0.80), 434: ("Low woodland with sparse understory", 0.58),
        510: ("Tall shrubland", 0.78), 520: ("Shrubland", 0.72), 531: ("Open shrubland with spinifex understory", 0.90), 532: ("Open shrubland with grassy understory", 0.75), 533: ("Open shrubland with sparse understory", 0.55),
        610: ("Sedgeland", 0.50), 620: ("Hummock grassland", 0.88), 631: ("Grassland", 0.82), 632: ("Open grassland", 0.78), 633: ("Sparse grassland", 0.55), 640: ("Croplands", 0.45),
        700: ("Horticulture", 0.20), 800: ("Wetlands", 0.10), 910: ("Water", 0.00), 920: ("Wildland urban interface 1", 0.70), 930: ("Wildland urban interface 2", 0.55), 940: ("Wildland urban interface 3", 0.40), 950: ("Built-up", 0.15), 960: ("Bare ground", 0.05),
    }
