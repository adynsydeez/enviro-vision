export default function MascotBubble({ text, isVisible = true }) {
  ...
  return (
    <div className="flex flex-col items-center gap-6 max-w-md mx-auto animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <img src="/mascot-ingame.png" alt="Mascot" className="w-24 h-24 md:w-40 md:h-40 object-contain drop-shadow-2xl" />
    </div>
  );
}
